...
zip ../emoji-selector@maestroschan.fr.zip emojiButton.js
zip ../emoji-selector@maestroschan.fr.zip emojiCategory.js
zip ../emoji-selector@maestroschan.fr.zip emojiOptionsBar.js
